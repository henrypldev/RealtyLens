...
export function SelectMusicStep({
  ...
  return (
    <div className="space-y-8">
      {/* Native Audio Toggle */}
      <div className="rounded-xl border-primary/30 border-2 bg-primary/5 p-6 transition-all">
        <div className="flex items-start gap-4">
          <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-primary text-white shadow-primary/20 shadow-lg">
        ...
        <div className="grid grid-cols-3 gap-3">
          {VIDEO_ASPECT_RATIOS.map((ratio) => (
            ...
            >
              ...
              {aspectRatio === ratio.id && <IconCheck className="h-4 w-4 text-primary" />}
            </button>
          ))}
        </div>
      </div>
      ...
      <div>
        ...
        >
          ...
          {selectedTrack === null && <IconCheck className="h-5 w-5 text-primary" />}
        </button>
        ...
        <div className="space-y-2">
          {filteredTracks.map((track) => (
            ...
            >
              ...
              {selectedTrack?.id === track.id && <IconCheck className="h-5 w-5 text-primary" />}
            </div>
          ))}
        </div>
      </div>
