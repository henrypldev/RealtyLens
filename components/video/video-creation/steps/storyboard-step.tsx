          ...
          <div className="relative h-10 w-10">
            <svg className="h-full w-full -rotate-90" viewBox="0 0 36 36">
              ...
              <path
                ...
                fill="none"
                stroke={
                  images.length === template.slots.length ? 'var(--accent-green)' : 'var(--primary)'
                }
              ...
              {index < template.slots.length - 1 && (
                ...
                >
                  <div className="group/match pointer-events-auto mb-2 flex items-center -space-x-2.5">
                    ...
                    <div className="z-10 flex h-7 w-7 items-center justify-center rounded-full border bg-background shadow-md transition-all group-hover/match:rotate-12 group-hover/match:scale-110 group-hover/match:border-primary">
                      <IconScissors
                        className="h-3.5 w-3.5 text-muted-foreground group-hover/match:text-primary"
              ...
              <div
                className={cn(
                  ...
                  image
                    ...
                    : 'border-muted-foreground/20 border-dashed hover:border-primary hover:bg-primary/5',
                  dragOverIndex === index &&
                    dragOverFrame === 'both' &&
                    'scale-[1.02] border-primary bg-primary/5 ring-primary/20 ring-2',
                  isUploading && 'cursor-wait border-primary',
                )}
              ...
              >
                ...
                <div className="flex h-full w-full">
                  ...
                  >
                    ...
                    <div className="absolute top-2 left-2 z-10 rounded-md bg-black/60 px-1.5 py-0.5 font-bold text-[9px] text-white uppercase tracking-wider backdrop-blur-sm transition-colors group-hover/start:bg-primary">
                      Start
                    </div>
                    ...
                    {dragOverIndex === index && dragOverFrame === 'start' && (
                      <div className="fade-in absolute inset-0 z-20 flex animate-in flex-col items-center justify-center bg-primary/80 duration-200">
                  ...
                  >
                    ...
                    <div className="absolute top-2 right-2 z-10 rounded-md bg-black/60 px-1.5 py-0.5 font-bold text-[9px] text-white uppercase tracking-wider backdrop-blur-sm transition-colors group-hover/end:bg-primary">
                      End
                    </div>
