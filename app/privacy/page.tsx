  ...
  return (
    ...
    >
      ...
      <LegalSection title="2. Information We Collect">
        ...
        <ul className="ml-4 list-disc space-y-2">
          ...
          <li>
            ...
            payment provider. We do not store your full credit card information.
          </li>
          <li>
            <strong>Images:</strong> Photos you upload for AI enhancement. These are processed and
            stored temporarily to deliver our service.
          </li>
          <li>
            <strong>Usage Data:</strong> Information about how you interact with our service,
            including features used and processing preferences.
          </li>
        </ul>
      </LegalSection>
      ...
      <LegalSection title="4. Data Storage and Security">
        <p>
          Your data is stored securely on servers located in the European Economic Area (EEA). We
          implement appropriate technical and organizational measures to protect your personal
          information against unauthorized access, alteration, disclosure, or destruction.
        </p>
        <p>
          Uploaded images are stored temporarily for processing and delivery. You may request
          deletion of your images at any time through your account settings or by contacting us.
        </p>
      </LegalSection>
      ...
      <LegalSection title="5. Data Sharing">
        ...
        <ul className="ml-4 list-disc space-y-2">
          <li>
            <strong>Service Providers:</strong> With third-party vendors who assist us in operating
            our service (e.g., cloud hosting, payment processing).
          </li>
          <li>
      ...
      <LegalSection title="7. Cookies">
        <p>
          We use essential cookies to maintain your session and preferences. Analytics cookies help
          us understand how visitors interact with our service. You can control cookie preferences
      ...
      <LegalSection title="8. Data Retention">
        <p>
          We retain your account information for as long as your account is active. Uploaded images
          are retained for 30 days after processing to allow for re-downloads, after which they are
