  ...
  return (
    ...
    >
      ...
      <LegalSection title="4. Payment and Pricing">
        ...
        <p>
          Prices are subject to change with reasonable notice. All payments are processed securely
          through our payment provider. Payments are non-refundable except as outlined in our refund
          policy.
        </p>
      </LegalSection>
      ...
      <LegalSection title="5. Refund Policy">
        ...
        <p>
          We reserve the right to deny refund requests that we determine, in our sole discretion, to
      ...
      <LegalSection title="6. User Content">
        ...
        <p>
          You represent and warrant that you have all necessary rights to upload and use the
          content, and that your content does not violate any third-party rights.
        </p>
      </LegalSection>
      ...
      <LegalSection title="7. Intellectual Property">
        ...
        <p>
          Enhanced images produced by our Service are owned by you, subject to any underlying rights
      ...
      <LegalSection title="13. Changes to Terms">
        ...
        <p>
          By continuing to access or use our Service after revisions become effective, you agree to
